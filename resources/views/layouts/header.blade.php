<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="{{route('parties.chart')}}" class="nav-link px-2">ติดตามผล</a></li>
        <li><a href="{{route('parties-pdf')}}" class="nav-link px-2">เอกสาร</a></li>
        <li><a href="{{route('parties.contact')}}" class="nav-link px-2">ติดต่อ</a></li>
